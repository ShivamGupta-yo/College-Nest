          ...
          <div className="Kdcard">
            <div className="Kdcard-body">
              <div className="Kdimage-container">
                <img src="images/pg.png" alt="Green Building" />
              </div>
              <div className="Kdroom-description">
                <p>
                  
                  <strong> {e.accomodation} </strong> is located near to the college
                  Campus. It provides rooms for both boys and girls. 
                </p>
                <br />
                <strong> Rooms Description: </strong> Single room with seperate
                kitchen and  washrooms attached with each
                room.
                <br />
