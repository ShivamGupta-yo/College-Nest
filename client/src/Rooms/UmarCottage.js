...
<div>
    <div>
      <div className="Umarcontainer">
        <div className="Umarsection">
          <div className="Umardescription ">
            <h1>Umar Cottage</h1>
          </div>
        </div>

        <div className="Umarsection">
          <div className="Umarcard">
            <div className="Umarcard-body">
              <div className="Umarimage-container">
                <img src="/images/Umar1.jpg" alt="Green Building" />
                <img src="/images/Umar2.jpg" alt="Green Building" />
              </div>
              <div className="Umarroom-description">
                <p>
                  The Umar Cottage Commonly known as
                  <strong>{e.accomodation} </strong> is located within the 500m of college
                  premises. It provides rooms for both boys and girls. This
                  building also has necessities shops of food and stationary
                  near to it.
                </p>
                <br />
                <strong> Rooms Description: </strong> Single room with a open
                kitchen(within the room) seperate washrooms attached with each
                room.
                <br />
                Total number of rooms in the Building are : {e.rooms}
                <br />
              </div>
              <div className="Umarfacilities">
                ...
                <ul>
                  ...
                  <li>
                    Shop for stationary and food items available near the
                    building
                  </li>
                ...
                <ul>
                  ...
                  <li>
                    There is no strict rule regarding the opening and closing
                    times of buildings, but you should not be wandering around
                    late at night.
                  </li>
                </ul>
