            ...
            <div className="Cdcard-body">
              ...
              <div className="Cdroom-description">
                <p>
                  ...
                  <strong>Usha Sharma Niwas </strong> is located near to the college
              ...
              <div className="Cdfacilities">
                ...
                <ul>
                  ...
                  <li>
                    {" "}
                    Beds are provided (according to the number of room partners){" "}
                  </li>
                  <li>
                ...
                Rent of This Building is {e.rentB} for boys and {e.rentG} for girls (Rent may be divided
