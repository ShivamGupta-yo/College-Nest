          ...
          <div className="Sharmacard">
            <div className="Sharmacard-body">
              ...
              <div className="Sharmaroom-description">
                <p>
                  The {e.accomodation} is the three-storey building located within 100
                ...
                <ul>
                  <li>
                    Single room with 3 beds, 1 Cupboard, 1 Wooden Rack and an
                    attached washroom.
                  </li>
              ...
              <div className="Sharmafacilities">
                ...
                <ul>
                  ...
                  <li>
                    Shop for stationary and food items available near to PG
                  </li>
                </ul>
                <br />
                <h3>Rules: </h3>
                <ul>
                  ...
                  <li>
                    Gate Opening Time is 06:30 A.M. Gate Closing Time is 09:30
                    P.M.
                    <br />
