          ...
          <div className="Shivshakticard">
            <div className="Shivshakticard-body">
              ...
              <div className="Shivshaktiroom-description">
                <p>
                  The {e.accomodation} is the three-storey building located near
                  the college campus and is Exclusively for boys.
                </p>
                ...
                <ul>
                  <li>
                    Single room with 2-3 beds, 3 Cupboars and an attached
                    washroom.
                  </li>
              ...
              <div className="Shivshaktifacilities">
                ...
                <p>And it is Rs.5500 if milk is included in the diet.</p>
              </div>
            </div>
          </div>
        </div>
