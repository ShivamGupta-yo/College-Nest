          ...
          <div className="Suvidhacard">
            <div className="Suvidhacard-body">
              ...
              <div className="Suvidharoom-description">
                <p>
                  The {e.accomodation} is 3 storey building located near the college
                  campus. It is exclusively for BOYS.
                </p>
                ...
                <ul>
                  <li>
                    Single room with 2 beds, 1 Cupboard, 1Shelf,1 Almirah and an
                    attached washroom.
                  </li>
              ...
              <div className="Suvidhafacilities">
                ...
                <ul>
                  ...
                  <li>
                    Essential items such as: plate, spoon, mattress, bucket,
                ...
                <ul>
                  ...
                  <li>
                    Gate Opening Time is 05:30 A.M. Gate Closing Time is 09:00
                    P.M.
                    <br />
                ...
                <p>
                  ...
                  fixed at Rs. {e.rentB} for boys. (non-sharable between roommates)
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="Suvidhasection">
          ...
          <table>
            ...
            <tr>
              ...
              <td>(1st and 3rd week)Kadi/ (2nd and 4th week)Chana Dal, Rice</td>
              <td>Tea, Biscuit</td>
            ...
            <tr>
              <td>Sunday</td>
              <td>Chole and puri(1st and 3rd week)/Allu bhaji and Bhature(2nd and 4th week), tea</td>
              <td>pulao, raita</td>
              <td>Tea, Chowmin/maggi(2nd and 4th week)</td>
              <td>Matar Paneer/Chicken(1st and 3rd week), Chilli paneer(2nd and 4th week), Rice, Chapati</td>
            </tr>
          </table>
        </div>
            <div className="Suvidhasection">
