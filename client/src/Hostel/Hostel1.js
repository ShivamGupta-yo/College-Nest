...
const email = localStorage.getItem("email");
  return (
    <div className="hos">
      ...
      <p>  Hostel facility is provided by college for girls to support them financially and provide a secure environment
              Our college have two hostels for girls students only.</p>
      </div>
            ...
            <div className=" hostel col-md-3">
              <div className=" hostel card text-center anki">
                <div className=" hostel card-body">
                  ...
                  <h1>Saraswati</h1>
                  <p>
                  The Saraswati is located within
                  ...
                  {email && dbemail && dbemail != null && email != null ? (
                    <>
                      <Link to={"/saraswati"}>
                        <a className=" hostel btn btn-sm btn-primary">Click Here</a>
                      </Link>
                    </>
                  ) : (
                    <>
