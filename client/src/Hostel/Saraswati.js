        ...
        return (
          <>
            ...
            <p>Vacant Rooms: {e.vacant}</p> */}
             <div>
      <div>
        <div className="Sarascontainer">
          <div className="Sarassection">
            <div className="Sarasdescription ">
              <h1>Saraswati Hostel</h1>
            </div>
          </div>

          <div className="Sarassection">
            <div className="Sarascard">
              <div className="Sarascard-body">
                <div className="Sarasimage-container">
                  <img src="/images/saraswati.png" alt="Saraswati" />
                  <img src="/images/saraswati2.jpg" alt="Saraswati" />
                  <img src="/images/saraswati3.jpg" alt="Saraswati" />
                </div>
                <div className="Sarasroom-description">
                  <p>
                    <strong>The{e.accomodation} </strong> is located within
                    100m of college campus and it is exclusively for girls.{" "}
                    <br />
                    The total capacity of hostel is 99 girls with a total of {e.rooms}
                    rooms.
                  </p>
                  <br />
                  <strong> Rooms Description: </strong> Single room with3 beds
                  and common washrooms(2 rooms can share 1 washroom) at each
                  floor.
                  <br />
                  Total number of rooms in the Building are : {e.rooms}
                  <br />
                </div>
                <div className="Sarasfacilities">
                  ...
                  <ul>
                    ...
                    <li>
                      {" "}
                      Essential items provided (plate, spoon, mattress, bucket,
                      bathing jug, toilet brush, Harpic, Vim at mess)
                    </li>
                    <li>A small playground inside the boundary of hostel</li>
                    <li>
                      Provides study table, a chair and a cupboard for each
                      student
                    </li>
                  </ul>
                  <br />
                  ...
                  <ol>
                    <li>
                      The student who want to accomodate for hostel have to fill
                      a form (which is provided at admin office)
                    </li>
                    <li>
                      After submitting the form, the allocation will be done on
                      the merit basis (either at 12th percentage or at JEE
                      percentile)
                    </li>
                  </ol>
                  <em>For more details, Contact the wardens of the hostel.</em>
                  <br />
                  <h3> Charges Description:</h3>
                  Only mess charges of Rs. {e.rentG} per month have to be paid by the
                  girls. Rest of the charges are included in semester fee of the
                  college.
                  <br />
          ...
          <div className="Sarassection">
            ...
            <table>
              ...
              <tr>
                ...
                <td>चाय</td>
                <td>
                  सब्जी + चनेकी दाल + चपाती + चावल + हलवा / सेमवयाां / ब्रेड का
                  मीठा
                </td>
              </tr>
              <tr>
                ...
                <td>सैंडविच+ चाय</td>
                <td>
                  पनीर / नॉन वेज / मशरूम / दाल / फ्राइड राइस / सब्जी + चपाती +
                  चावल
                </td>
              </tr>
            </table>
